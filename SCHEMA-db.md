# GT3 Sistema — SQL Schema

Execute os blocos abaixo no **SQL Editor** do Supabase (uma única vez por ambiente).
...
## Trigger de Notificação (exemplo)

```sql
-- Trigger genérico para gerar notificações quando um módulo for atualizado.
-- Adapte para cada tabela necessária.
